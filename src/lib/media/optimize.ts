...
async function optimizeImage(asset: PickedMediaAsset, options: OptimizeOptions): Promise<PickedMediaAsset> {
...
async function optimizeVideo(asset: PickedMediaAsset, options: OptimizeOptions): Promise<PickedMediaAsset> {
